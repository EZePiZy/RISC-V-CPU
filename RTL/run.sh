...
verilator --Wall --cc --trace ../TYPES/types_pkg.sv CPU.sv -I../CONTROL_UNIT -I../DATA_MEMORY -I../SIGN_EXTEND -I../PC -I../REGFILE_ALU/REGFILE -I../REGFILE_ALU/ALU -I../DECODE_EXECUTE_REGISTER -I../EXECUTE_MEMORY_REGISTER -I../FETCH_DECODE_REGISTER -I../MEMORY_WRITEBACK_REGISTER --top-module CPU --exe $testbench
